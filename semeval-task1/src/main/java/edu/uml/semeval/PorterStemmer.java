...
public class PorterStemmer {
    ...
    /**
     * Adds wLen characters to the word being stemmed contained in a portion of a char[] array. This
     * is like repeated calls of add(char ch), but faster.
     */
    ...
    /*
     * cvc(i) is true <=> i-2,i-1,i has the form consonant - vowel - consonant and also if the
     * second c is not w,x or y. this is used when trying to restore an e at the end of a short
     * word. e.g.
     * 
     ...
     * stemming process resulted in a word different from the input. You can retrieve the result
     ...
     * word, and writes the result to standard output. Note that the word stemmed is expected to be
     * in lower case: forcing lower case must be done outside the Stemmer class. Usage: Stemmer
     * file-name file-name ...
     */
