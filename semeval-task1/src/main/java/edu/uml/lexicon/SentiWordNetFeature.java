...
public class SentiWordNetFeature {
    ...
    public boolean isPositiveMajority() {
        return getNonZeroPositiveCount() > getNonZeroNegativeCount()
                && getNonZeroPositiveCount() > getNonZeroObjectiveCount();
    }

    public boolean isNegativeMajority() {
        return getNonZeroNegativeCount() > getNonZeroPositiveCount()
                && getNonZeroNegativeCount() > getNonZeroObjectiveCount();
    }

    public boolean isObjectiveMajority() {
        return isPositiveMajority() == false && isNegativeMajority() == false;
    }
    
    public boolean isPositiveAdjectiveMajority() {
        return getNonZeroPositiveAdjectiveCount() > getNonZeroNegativeAdjectiveCount()
                && getNonZeroPositiveAdjectiveCount() > getNonZeroObjectiveAdjectiveCount();
    }
    
    public boolean isNegativeAdjectiveMajority() {
        return getNonZeroNegativeAdjectiveCount() > getNonZeroPositiveAdjectiveCount()
        && getNonZeroNegativeAdjectiveCount() > getNonZeroObjectiveAdjectiveCount();
    }
    
    public boolean isObjectiveAdjectiveMajority() {
        return isPositiveAdjectiveMajority() == false && isNegativeAdjectiveMajority() == false;
    }
    ...
    public boolean isMorePositiveAdjective() {
        return getNonZeroPositiveAdjectiveCount() > getNonZeroNegativeAdjectiveCount();
    }
}
