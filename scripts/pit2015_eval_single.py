...
def EvalSingleSystem(testlabelfile, outputfile):
    ...
    if hasscore == False:
        evalresult = testsize + bar + teamname + bar + nameofrun + bar + bar + "{0:.3f}".format(
            F) + bar + "{0:.3f}".format(P) + bar + "{0:.3f}".format(R) \
    ...
    evalresult = testsize + bar + teamname + bar + nameofrun + bar + bar + "{0:.3f}".format(F) + bar + "{0:.3f}".format(
        P) + bar + "{0:.3f}".format(R) \
                 + bar + bar + "{0:.3f}".format(pcorrelation) + bar + "{0:.3f}".format(maxF1) + bar + "{0:.3f}".format(
        P_maxF1) + bar + "{0:.3f}".format(R_maxF1)
